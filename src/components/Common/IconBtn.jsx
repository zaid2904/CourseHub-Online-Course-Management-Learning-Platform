export default function IconBtn({
  ...
  return (
    <button
      disabled={disabled}
      onClick={onclick}
      className={`inline-flex min-h-[44px] items-center justify-center gap-x-2 rounded-full px-6 py-3 text-sm font-semibold transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500/10 disabled:opacity-50 disabled:cursor-not-allowed ${
        outline
